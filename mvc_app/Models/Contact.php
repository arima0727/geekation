...
class Contact extends Db
{
     ...
     */
    public function create(string $name, string $kana, string $email, string $tel, string $body)
    {
        try{
     ...
     * @param string $body お問い合わせ内容
     */
    public function update(string $id, string $name, string $kana, string $email, string $tel, string $body): bool
    {
        try{
